...
static inline void print_array_byletters(uint8_t* array, size_t length);
...
int main(void) {
    ...
    // 64 битный ключ
    uint8_t key64b[8] = {'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h'};
    ...
    print_array_byletters(decrypted, length);

    return 0;
}
// расширение ключа с помощью раундовых ключей
